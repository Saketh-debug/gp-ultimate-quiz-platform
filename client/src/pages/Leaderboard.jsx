    ...
    >
      ...
      <main className="max-w-2xl mx-auto w-full px-6 pb-20 pt-10">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-7" noValidate>
            ...
            <div>
              ...
              {errors.participant_name && (
                <p className="mt-1 text-xs font-bold" style={{ color: "#ef4444" }}>This field is required.</p>
              )}
            </div>
            ...
            <div>
              <label style={labelStyle}>
                Institution Name <span style={{ color: "#f97316" }}>*</span>
              </label>
              <input
                type="text"
                value={form.institution}
                onChange={(e) => set("institution", e.target.value)}
                placeholder="Your college or organisation"
            ...
            <div>
              <label style={labelStyle}>
                How did you feel about the event flow (schedule, timing, structure)?{" "}
                <span style={{ color: "#f97316" }}>*</span>
              </label>
              <textarea
                rows={3}
                value={form.q_event_flow}
                onChange={(e) => set("q_event_flow", e.target.value)}
                placeholder="Share your thoughts…"
                style={inputStyle("q_event_flow")}
              />
              {errors.q_event_flow && (
                <p className="mt-1 text-xs font-bold" style={{ color: "#ef4444" }}>This field is required.</p>
              )}
            ...
            <div>
              <label style={labelStyle}>
                How would you say the hospitality and event support was?{" "}
                <span style={{ color: "#f97316" }}>*</span>
              </label>
              <textarea
                rows={3}
                value={form.q_hospitality}
                onChange={(e) => set("q_hospitality", e.target.value)}
                placeholder="Share your thoughts…"
                style={inputStyle("q_hospitality")}
              />
              {errors.q_hospitality && (
                <p className="mt-1 text-xs font-bold" style={{ color: "#ef4444" }}>This field is required.</p>
              )}
            </div>

            {/* Favourite part — optional */}
            <div>
              <label style={{ ...labelStyle, color: "rgba(255,255,255,0.4)" }}>
                What was your favourite part of the event?{" "}
                <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 11 }}>(optional)</span>
              </label>
              <textarea
                rows={3}
                value={form.q_fav_part}
                onChange={(e) => set("q_fav_part", e.target.value)}
                placeholder="Optional — leave blank if you prefer"
                style={{
                  ...inputStyle("q_fav_part"),
            ...
            <div>
              ...
              <div className="flex items-center gap-3 flex-wrap mt-2">
                ...
                {RATINGS.map(({ value, label }) => (
                  ...
                  >
                    <input
                      type="radio"
                      name="q_overall_rating"
                      value={value}
                      checked={form.q_overall_rating === String(value)}
                      onChange={(e) => set("q_overall_rating", e.target.value)}
                      style={{ display: "none" }}
                    />
                    <span
                      className="flex items-center justify-center w-9 h-9 rounded-full font-black text-sm transition-all duration-150"
                      style={{
                        background: form.q_overall_rating === String(value)
                          ? "linear-gradient(135deg,#f97316,#f4a460)"
                          : "rgba(255,255,255,0.06)",
                        border: form.q_overall_rating === String(value)
                          ? "2px solid #f97316"
                          : "2px solid rgba(255,255,255,0.1)",
                        color: form.q_overall_rating === String(value) ? "#000" : "rgba(255,255,255,0.6)",
                        boxShadow: form.q_overall_rating === String(value)
              ...
              {errors.q_overall_rating && (
                <p className="mt-2 text-xs font-bold" style={{ color: "#ef4444" }}>Please select a rating.</p>
              )}
            </div>
            ...
            <div>
              ...
              <textarea
                rows={3}
                value={form.q_suggestions}
                onChange={(e) => set("q_suggestions", e.target.value)}
                placeholder="We'd love to hear how we can do better…"
                style={inputStyle("q_suggestions")}
              />
              {errors.q_suggestions && (
                <p className="mt-1 text-xs font-bold" style={{ color: "#ef4444" }}>This field is required.</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 rounded-xl font-black text-base uppercase tracking-widest transition-all duration-200"
              style={{
                background: submitting
                  ? "rgba(249,115,22,0.3)"
                  : "linear-gradient(135deg,#f97316,#d15b2c)",
                color: "#fff",
                boxShadow: submitting ? "none" : "0 0 24px rgba(249,115,22,0.35)",
